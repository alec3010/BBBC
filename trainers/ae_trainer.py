...
class AETrainer(Trainer):
        ...
        with torch.autograd.set_detect_anomaly(True):
            for epoch in range(self.epochs):
                ...
                for (x, y) in zip(self.train_x, self.train_y):
                    ...
                    pred, mu, mu_list = self.model(x[k+1:-k], y[k:-k-1], future_acs=future_acs, past_acs=past_acs) # vae, pytorch , mu_s, log_sigma_s 
    ...
    def eval(self, epoch):     
        ...
        print('VAE {}|| TOT: {} || OBS || REC: {} | 1FWD: {} | 1BWD: {} | KFWD: {} | KBWD: {} | ACS || 1FWD: {} | KFWD: N/A'\
            .format(epoch_str, 
                    avg_loss, 
                    avg_rec_loss,
                    avg_obs_1fwd_loss, 
